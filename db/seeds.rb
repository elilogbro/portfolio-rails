...
p1 = Project.create(name: 'Playlist Creator', github_url: 'https://github.com/elilogbro/Playlist-App', image: '/Playlist.png', details: 'This playlist application was created to easily manage favorite songs, see their lyrics, and')
...
Video.create(embed_code: 'https://www.loom.com/embed/1c4c3880f1134ebaa9797cf213ebe34f', project_id: p4.id)
Video.create(embed_code: 'https://www.loom.com/embed/af073518dbb4473c8fc672874e5ba27c', project_id: p3.id)
Video.create(embed_code: 'https://www.loom.com/embed/771527abe6f04fe793fdabd89bf99b1e', project_id: p2.id)
Video.create(embed_code: 'https://www.loom.com/embed/e1be8bb3804d467eb9a16446462cc478', project_id: p1.id)
